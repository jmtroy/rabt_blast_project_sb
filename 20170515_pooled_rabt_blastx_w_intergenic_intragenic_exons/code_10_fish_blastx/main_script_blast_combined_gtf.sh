...
COMB_GTF=/home/groups/simons/Joe/rabt_blast_project_sb/input_data/rabt_pooled_ensembl_gtf_code/output/D30C_w_rpkm_counts.gtf
################# D30C_intERgenic ###########################
...
# TODO make sure the below input files are correct
COMB_GTF=/home/groups/simons/Joe/rabt_blast_project_sb/input_data/rabt_pooled_ensembl_gtf_code/output/T30C_w_rpkm_counts.gtf
################# T30C_intERgenic ###########################
# set grep var to find intergenic exons
GREP_VAR='class_code "u"'
# set file prefix to name files as intergenic
